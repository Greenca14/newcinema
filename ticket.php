...
<body>
    ...
    <div class="container">
        <div class="texthold">
            <div class="card">
                ...
                <button type="button" onclick="showSeatSelection()">Выбрать место</button>
                <button type="button" onclick="processUserPayment()">Оплатить</button>
    ...
    <div class="overlay" id="paymentPopupOverlay">
    ...
    <script>
        ...
        function showPopup(message) {
            const overlay = document.querySelector('#paymentPopupOverlay');
            const popup = document.querySelector('#paymentPopup');
        ...
        function showSeatSelection() {
          const popupOverlay = document.getElementById('seatSelectionPopup');
          popupOverlay.classList.add('active'); // Добавляем класс active
          const popup = popupOverlay.querySelector('.popup');
          popup.classList.add('active'); // Добавляем класс active для popup
        }

        function closeSeatSelection() {
            const popupOverlay = document.getElementById('seatSelectionPopup');
            popupOverlay.classList.remove('active'); // Убираем класс active
            const popup = popupOverlay.querySelector('.popup');
            popup.classList.remove('active'); // Убираем класс active для popup
        }
